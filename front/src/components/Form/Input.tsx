    ...
    return (
        <div>
            <div className="relative z-0 my-5">
                ...
                <label
                    htmlFor={name}
                    className="absolute duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 peer-focus:text-primary">
                    {label}
                </label>
                <ErrorMessage
                    name={name}
